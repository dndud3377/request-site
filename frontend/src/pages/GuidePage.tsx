...
const SECTIONS: SectionOption[] = [
  ...
  { value: 'general',        labelKey: 'guide.section_general' },
  { value: 'line_combination', labelKey: 'guide.section_line_combination' },
  { value: 'jayer',          labelKey: 'guide.section_jayer' },
  { value: 'oayer',          labelKey: 'guide.section_oayer' },
  { value: 'bone',           labelKey: 'guide.section_bone' },
  { value: 'map',            labelKey: 'guide.section_map' },
  { value: 'cfamily',        labelKey: 'guide.section_cfamily' },
  { value: 'xmark',          labelKey: 'guide.section_xmark' },
  { value: 'separation',     labelKey: 'guide.section_separation' },
];

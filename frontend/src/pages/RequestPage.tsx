...
import { CreateDocumentInput, ProductType, MapType, Priority } from '../types';

type FormState = Omit<CreateDocumentInput, never>;
...
export default function RequestPage(): React.ReactElement {
  ...
  const handleSaveDraft = async () => {
    ...
    try {
      if (savedId) {
        await documentsAPI.update(savedId, form);
      } else {
  ...
  const productTypes: SelectOption[] = [
    { value: 'new', labelKey: 'request.product_type_new' },
    { value: 'update', labelKey: 'request.product_type_update' },
    { value: 'add_feature', labelKey: 'request.product_type_add_feature' },
    { value: 'change', labelKey: 'request.product_type_change' },
  ];

  const mapTypes: SelectOption[] = [
    { value: 'intro', labelKey: 'request.map_type_intro' },
    { value: 'feature', labelKey: 'request.map_type_feature' },
    { value: 'comparison', labelKey: 'request.map_type_comparison' },
    { value: 'roadmap', labelKey: 'request.map_type_roadmap' },
  ];

  const priorities: SelectOption[] = [
    { value: 'low', labelKey: 'request.priority_low' },
    { value: 'medium', labelKey: 'request.priority_medium' },
    { value: 'high', labelKey: 'request.priority_high' },
    { value: 'urgent', labelKey: 'request.priority_urgent' },
  ];
  ...
  return (
    <div className="container page">
      ...
      <div className="form-section">
        ...
        <div className="form-grid">
          <FormField label={t('request.product_name')} name="product_name" required>
            <input
          ...
          <FormField label={t('request.product_name_en')} name="product_name_en">
            <input
              className="form-control"
          ...
          <FormField label={t('request.product_type')} name="product_type" required>
            <select
              className="form-control"
              name="product_type"
          ...
          <FormField label={t('request.product_version')} name="product_version">
            <input
              className="form-control"
          ...
          <div className="form-group full-width">
            ...
            {errors.product_description && (
              <span className="form-error">{errors.product_description}</span>
            )}
          </div>
          <div className="form-group full-width">
      ...
      <div className="form-section">
        ...
        <div className="form-grid">
          <FormField label={t('request.map_type')} name="map_type" required>
            <select
              className="form-control"
              name="map_type"
              value={form.map_type}
          ...
          <FormField label={t('request.priority')} name="priority">
            <select
              className="form-control"
              name="priority"
              value={form.priority}
          ...
          <FormField label={t('request.deadline')} name="deadline">
            <input
              type="date"
              className="form-control"
              name="deadline"
          ...
          <div className="form-group full-width">
            ...
            />
            {errors.key_features && (
              <span className="form-error">{errors.key_features}</span>
            )}
          </div>
          <div className="form-group full-width">

...
USERS = [
  ...
  {'loginid': 'pl_gl3',    'name': '해외슈가','role': 'PL_GL','deptname': 'GLOBAL PA3','mail': 'pl.gl3@company.com'},
  {'loginid': 'pl_gl4',    'name': '해외제이홉','role': 'PL_GL','deptname': 'GLOBAL PA4','mail': 'pl.gl4@company.com'},
  {'loginid': 'pl_gl5',    'name': '해외지민','role': 'PL_GL', 'deptname': 'GLOBAL YE', 'mail': 'pl.gl5@company.com'},
  ...
  {'loginid': 'agent_p1',  'name': '원이',  'role': 'TE_P',   'deptname': 'PHPSI',    'mail': 'agent.p1@company.com'},
  {'loginid': 'agent_p2',  'name': '미나미','role': 'TE_P',   'deptname': 'PHPSI',    'mail': 'agent.p2@company.com'},
  {'loginid': 'agent_p3',  'name': '제나',  'role': 'TE_P',   'deptname': 'PHPSI',    'mail': 'agent.p3@company.com'},

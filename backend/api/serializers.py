...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'receive_all_mail', 'mail_lines', 'receive_voc_mail', 'receive_submit_mail',
        ]
        read_only_fields = [
            'role_assigned_at', 'receive_all_mail', 'mail_lines', 'receive_voc_mail',
            'receive_submit_mail',
        ]
...
class RequestDocumentSerializer(DocPermFieldsMixin, serializers.ModelSerializer):
    ...
    map_table_cc_exists = serializers.SerializerMethodField()
    ...
    class Meta:
        ...
        fields = [
            ...
            'shared_group', 'shared_group_name', 'review_items', 'layer_drift_detected', 'map_table_cc_exists',
        ]
    ...
    def get_map_table_cc_exists(self, obj):
